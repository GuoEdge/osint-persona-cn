...
def test_pick_subtitle_prefers_ai_chinese():
    tracks = [
        ...
        {"lan": "zh-CN", "lan_doc": "中文", "type": "cc", "subtitle_url": "https://example.com/cc"},
    ]
...
def test_pick_subtitle_cc_first_prefers_cc():
    tracks = [
        {"lan": "zh-CN", "lan_doc": "中文（自动生成）", "subtitle_url": "https://example.com/ai"},
        {"lan": "zh-CN", "lan_doc": "中文", "type": "cc", "subtitle_url": "https://example.com/cc"},
    ]
    picked = pick_subtitle_track(tracks, prefer="cc_first")
    assert picked is not None
    assert picked.get("type") == "cc"
